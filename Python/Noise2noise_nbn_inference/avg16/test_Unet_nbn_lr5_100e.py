...
CSV_path = '/afs/crc.nd.edu/user/v/vmannam/Desktop/Fall19/Sep19/2409/Keras_inference/Keras_models/nbn_folder/lr5/'
...
def test():
    ...
    io.savemat('test_nbn_Estimated_result_c5_avg16.mat', dict([('test_nbn_Estimated_result_c5_avg16',test_results)]))
