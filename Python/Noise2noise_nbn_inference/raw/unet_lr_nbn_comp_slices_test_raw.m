...
format long
font = 14;
est21 = load('test_nbn_Estimated_result_c5.mat');
est21 = est21.test_nbn_Estimated_result_c5;
est21 = double(est21);
test_samples = 48;
slices = 4;
imsize = 256;
...
figure(1);
subplot(2,2,1),imagesc(ip1(50:100,50:100),[min(ip1(:)),max(ip1(:))]);
title('input')
colorbar
set(gca,'FontSize',font)
%colormap(map)
subplot(2,2,2),imagesc(tar1(50:100,50:100),[min(ip1(:)),max(ip1(:))])
title('clean image')
colorbar
set(gca,'FontSize',font)
subplot(2,2,3),imagesc(est1(50:100,50:100),[min(ip1(:)),max(ip1(:))])
title('estimated image')
colorbar
set(gca,'FontSize',font)
diffx1 = est11-tar11;
subplot(2,2,4),imagesc(diffx1(50:100,50:100),[min(diffx1(:)),max(diffx1(:))])
